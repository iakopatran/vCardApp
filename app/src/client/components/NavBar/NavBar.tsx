import { Coins, LogIn, Menu } from 'lucide-react'
    ...
    <div className="hidden lg:flex lg:flex-1 gap-3 justify-end items-center">
      ...
      {isUserLoading ? null : !user ? (
        <WaspRouterLink
          ...
          className={cn(
            'font-semibold leading-6 ml-3 transition-all duration-300',
            {
              'text-sm': !isScrolled,
              'text-xs': isScrolled,
            }
        ...
        <div className="ml-3 flex items-center gap-3">
          <ReactRouterLink
            ...
            className="flex items-center gap-1.5 rounded-full bg-muted px-3 py-1 text-xs font-medium text-foreground hover:bg-accent transition-colors"
          >
                ...
                {isUserLoading ? null : !user ? (
                  ...
                  <>
                    <ReactRouterLink
                      ...
                      className="flex items-center gap-2 mb-4 rounded-lg bg-muted px-3 py-2 text-sm font-medium text-foreground hover:bg-accent transition-colors"
                    >
